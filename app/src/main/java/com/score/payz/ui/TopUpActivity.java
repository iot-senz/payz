...
//        }
    ...
    private void initUi() {
        ...
        cancel.setOnClickListener(TopUpActivity.this);
...
//-------------------------------------------------
    ...
    private void onClickPut() {
        ...
        try {
            ...
            new SenzorsDbSource(TopUpActivity.this).createPay(pay);
    ...
    private class SenzCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
            ActivityUtils.hideSoftKeyboard(TopUpActivity.this);
    ...
    public void displayInformationMessageDialog(String message) {
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ActivityUtils.showProgressDialog(TopUpActivity.this, "Please wait...");
    ...
    private void navigatePayDetails(Pay pay) {
        ...
        Intent intent = new Intent(TopUpActivity.this, PayDetailsActivity.class);
