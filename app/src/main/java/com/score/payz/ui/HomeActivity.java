...
public class HomeActivity extends FragmentActivity {
    ...
    private void initDrawerList() {
        ...
        drawerItemList.add(new DrawerItem("# PayZ [10.20$]", "#5f82c3", R.drawable.drawer_list_row_selector, R.drawable.drawer_list_row_selector, true, false));
        ...
        drawerItemList.add(new DrawerItem("# Settings", "#5f82c3", R.drawable.drawer_list_row_selector, R.drawable.drawer_list_row_selector, false, false));
